        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasicFees = table.Column<float>(type: "real", nullable: false),
                    AdvancedFees = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamFees = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseFees = table.Column<float>(type: "real", nullable: false),
                    LastDateOfPayment = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsTrashed = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                table: "AdminLogins",
                columns: new[] { "AdminLoginId", "Password", "UserName" },
